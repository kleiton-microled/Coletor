Public Class BD
    ...
    Shared Sub New()
        ...
        Try
            ...
            SenhaEncriptada = ConfigurationManager.AppSettings("SenhaEncriptada").ToString()

            If Val(SenhaEncriptada) = 1 Then

                Dim BaseHomologacao As Boolean =
                    Convert.ToBoolean(Convert.ToInt16(ConfigurationManager.AppSettings("BaseHomologacao").ToString()))

                Dim ws As New loginMicroled.CriptografiaSoapClient
