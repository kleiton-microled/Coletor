        ...
        <body>
            <div class="wrapper">
                ...
                <div class="content" style="margin: 25px;">
                    <form id="form1" runat="server" submitdisabledcontrols="False" class="uk-grid-small" uk-grid>
                        ...
                        <div class="uk-width-1-6@l">
                            <label>
                                <asp:CheckBox ID="ckAnvisa" runat="server" Text="Anvisa" Enabled="False"
                                    class="uk-checkbox uk-width-1-2 uk-height-1-1" /> ANVISA
                            </label>
                            ...
                            <tr>
                                <td class="auto-style208" colspan="5">
                                    ...
                                    <cc1:ModalPopupExtender ID="ModalPopupExtender1" runat="server"
                                        ...
                                        X="20" PopupDragHandleControlID="pnConfirma" TargetControlID="btnFecharConfirm"
