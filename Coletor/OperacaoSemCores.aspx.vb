Public Class OperacaoSemCores
                ...
                Select Case e.CommandName
                    ...
                    Case "DEL"
                        ...
                        If Me.cbLotes.SelectedIndex > 0 Then
                            ...
                            If OrdensOBJ.ValidarExclusaoDesova(OrdensOBJ) Then
                                If OrdensOBJ.ExcluirDesova(OrdensOBJ, Me.cbConteiner.SelectedItem.Text) Then
    ...
    Private Sub CarregarConteineres()
        ...
        Ds = Ordens.ConsultarConteineres(Session("AUTONUMPATIO"))

        Me.cbConteiner.DataTextField = "DISPLAY"
        Me.cbConteiner.DataValueField = "AUTONUM"

        Me.cbConteiner.DataSource = Ds
    ...
    Private Sub CarregarLotesConteiner(ByVal Autonum_Cntr As Integer)
        ...
        Dim Ds As New DataTable
        Ds = Ordens.ConsultarLotesConteiner(Autonum_Cntr, 0)

        Me.cbLotes.DataTextField = "DISPLAY"
        Me.cbLotes.DataValueField = "AUTONUM"

        Me.cbLotes.DataSource = Ds
        Me.cbLotes.DataBind()
    ...
    Private Sub Carrega_DadosLote()
        ...
        If Me.cbConteiner.SelectedIndex <> 0 Then
            ...
            OrdensOBJ = OrdensOBJ.RetornarDadosTela(Me.cbLotes.SelectedValue, Me.cbConteiner.SelectedValue)

            If OrdensOBJ IsNot Nothing Then
                Me.txtEtiquetas.Text = OrdensOBJ.Obs_Desova_Col.Replace("<br/>", vbCrLf)
            Else
                Me.txtEtiquetas.Text = String.Empty
    ...
    Private Sub Carrega_Itens_Desovados(ByVal Lote As Integer, ByVal Autonum_Cntr As Integer)
        ...
        Dim Ds As New DataTable
        Ds = Ordens.MostrarDesovas(Lote, Autonum_Cntr, 0)
    ...
    Private Sub Carrega_Itens_Manifestados(ByVal Lote As Integer, ByVal Autonum_Cntr As Integer)
        ...
        Dim Ds As New DataTable
        Ds = Ordens.ConsultarItensManifestados(Lote, Autonum_Cntr)

        Me.cbItem.DataTextField = "DISPLAY"
        Me.cbItem.DataValueField = "AUTONUM"

        Me.cbItem.DataSource = Ds
        Me.cbItem.DataBind()
    ...
    Private Sub ConfirmaDesovaItem()
        ...
        Try
            ...
            If OrdensOBJ.InserirDesova(OrdensOBJ) Then
