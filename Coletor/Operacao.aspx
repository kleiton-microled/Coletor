            ...
            <div class="content" style="margin: 25px;">
                <div class="uk-grid-small" uk-grid>
                    ...
                    <div class="uk-width-1-2">
                        ...
                        <asp:TextBox ID="txtEtiquetas" runat="server" AutoPostBack="True" class="uk-textarea" rows="3">
                        </asp:TextBox>
                    </div>
                    <div class="uk-width-1-2">
                                ...
                                <td class="auto-style208" colspan="5">
                                    <asp:Panel ID="pnConfirma" runat="server" Height="57px" Width="515px" Visible="False">
                                        <div align="center" style="background:#FFF68F; padding:10px; padding:10px;">
                                            <b><span class="auto-style215">Atenção: Divergência de IMO com a captação.
                                                    Deseja
                                            ...
                                            <strong><span class="auto-style2">
                                                    <asp:TextBox ID="txtQM" runat="server" BackColor="White"
                                                        BorderWidth="1px" CssClass="style23" Height="18px" Visible="False"
                                                        Width="16px">
                                                    </asp:TextBox>
                                                    <asp:TextBox ID="TxtIMOCAP" runat="server" BackColor="Gray"
                                                        BorderWidth="0px" CssClass="style23" Height="17px" Visible="False"
                                                        Width="20px"></asp:TextBox>
                                                    <asp:TextBox ID="TxtEMB" runat="server" BackColor="Gray"
                                                        BorderWidth="0px" CssClass="style23" Height="18px" Visible="False"
                                                        Width="27px">
                                                    </asp:TextBox>
                                                </span></strong>
                                            <br />
                                    ...
                                    <cc1:ModalPopupExtender ID="ModalPopupExtender1" runat="server"
                                        ...
                                        PopupDragHandleControlID="pnConfirma" TargetControlID="btnFecharConfirm"
